    ...
    <main className="relative h-screen flex flex-col">
      ...
      <section className="m-auto w-1/2 relative">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 w-fit bg-[#454343] p-2 rounded-md cursor-pointer font-light text-sm hover:bg-[#5a5a5a] transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed"
        >
          <Image
            src="/enterIcon.svg"
            alt="Enter"
